import 'package:delivery_app/src/models/mercado_pago_credit_cart.dart';
import 'package:delivery_app/src/models/mercado_pago_customer.dart';
import 'package:delivery_app/src/models/mercado_pago_tax.dart';
import 'package:delivery_app/src/models/mercado_pago_transaction_detail.dart';
...
class MercadoPagoPayment {
  ...
  MercadoPagoPayment.fromJson(Map<String, dynamic> json) {
    ...
    payer = json['payer'] is MercadoPagoCustomer
        ? json['payer']
        : MercadoPagoCustomer.fromJson(json['payer'] ?? {});
    ...
    transactionDetails =
        ...
        : MercadoPagoTransactionDetail.fromJson(
            json['transaction_details'] ?? {},
          );
    ...
    card = json['card'] is MercadoPagoCreditCard
        ? json['card']
        : MercadoPagoCreditCard.fromJson(json['card'] ?? {});

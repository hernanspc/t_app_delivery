...
import 'package:delivery_app/src/pages/client/orders/list/client_orders_list_controller.dart';
...
class ClientOrdersListPage extends StatelessWidget {
  ClientOrderListController con = Get.put(ClientOrderListController());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      alignment: Alignment.centerLeft,
                      child: Text(
                        'Repartidor:  ${order.delivery?.name ?? 'Aún no asignado'}  ${order.delivery?.lastname ?? ''}',
                      ),
                    ),
                    Container(
                      margin: const EdgeInsets.only(top: 5),

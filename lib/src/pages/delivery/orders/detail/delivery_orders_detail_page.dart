...
class DeliveryOrdersDetailPage extends StatelessWidget {
  DeliveryOrdersDetailController con = DeliveryOrdersDetailController();
  ...
  Widget _ButtonUpdateOrder(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Text('Iniciar Entrega', style: TextStyle(color: Colors.white)),
      ),
    );
  }
  ...
  Widget _buttonGoToOrderMap() {
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Text('Volver al Mapa', style: TextStyle(color: Colors.black)),
      ),
    );
  }
}
